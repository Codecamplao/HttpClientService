...
namespace HttpClientService
{
    public interface IHttpService
    {
        ...
        Task<HttpResponseWrapper<T>> Delete<T>(string url, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T>> Delete<T>(string url, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T>> Delete<T>(string url, string healthCheck, AuthorizeHeader auth, double timeout = 100);
        Task<HttpResponseWrapper<T>> Delete<T>(string url, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T>> Delete<T>(string url, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T>> Delete<T>(string url, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Delete<T, TError>(string url, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Delete<T, TError>(string url, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Delete<T, TError>(string url, AuthorizeHeader auth, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Delete<T, TError>(string url, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Delete<T, TError>(string url, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Delete<T, TError>(string url, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        ...
        Task<HttpResponseWrapper<T, TError>> Get<T, TError>(string url, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Get<T, TError>(string url, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Get<T, TError>(string url, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Get<T, TError>(string url, AuthorizeHeader auth, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Get<T, TError>(string url, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T, TError>> Get<T, TError>(string url, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T>> Get<T>(string url, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T>> Get<T>(string url, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T>> Get<T>(string url, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T>> Get<T>(string url, AuthorizeHeader auth, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<T>> Get<T>(string url, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<T>> Get<T>(string url, string healthCheck, double timeout = 100);
        ...
        Task<HttpResponseWrapper<TResponse, TError>> Post<T, TResponse, TError>(string url, T data, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Post<T, TResponse, TError>(string url, T data, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Post<T, TResponse>(string url, T data, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Post<T, TResponse>(string url, T data, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Post<T, TResponse, TError>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Post<T, TResponse, TError>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Post<T, TResponse>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Post<T, TResponse>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Post<T, TResponse, TError>(string url, T data, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Post<T, TResponse, TError>(string url, T data, AuthorizeHeader auth, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Post<T, TResponse>(string url, T data, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Post<T, TResponse>(string url, T data, AuthorizeHeader auth, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<object>> Post<T>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<object>> Post<T>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<object>> Post<T>(string url, T data, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<object>> Post<T>(string url, T data, AuthorizeHeader auth, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<object>> Post<T>(string url, T data, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<object>> Post<T>(string url, T data, string healthCheck, double timeout = 100);
        ...
        Task<HttpResponseWrapper<TResponse, TError>> Put<T, TResponse, TError>(string url, T data, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Put<T, TResponse, TError>(string url, T data, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Put<T, TResponse>(string url, T data, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Put<T, TResponse>(string url, T data, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Put<T, TResponse, TError>(string url, T data, string healthCheck, List<HttpHeaderWrapper> headers, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Put<T, TResponse, TError>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Put<T, TResponse>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Put<T, TResponse>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Put<T, TResponse, TError>(string url, T data, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse, TError>> Put<T, TResponse, TError>(string url, T data, AuthorizeHeader auth, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Put<T, TResponse>(string url, T data, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<TResponse>> Put<T, TResponse>(string url, T data, AuthorizeHeader auth, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<object>> Put<T>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
        Task<HttpResponseWrapper<object>> Put<T>(string url, T data, List<HttpHeaderWrapper> headers, string healthCheck, double timeout = 100);
        Task<HttpResponseWrapper<object>> Put<T>(string url, T data, AuthorizeHeader auth, string healthCheck, CancellationToken cancellationToken, double timeout = 100);
